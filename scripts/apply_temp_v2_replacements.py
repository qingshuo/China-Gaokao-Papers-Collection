...
REPLACEMENTS = {
    ...
    "deekur-2023-41-math": {
        "source": "temp/版本2：数学（按省份分类）2008-2024/2008-2024·（河北）数学高考真题/2023年高考数学试卷（新课标Ⅰ卷）（空白卷）.pdf",
        "old_sha256": "84e40d21b4c15900d9ccc97668c553cea1ca84fa677f742c45ba278aa9ca468f",
        "new_sha256": "009f7fc761e05596dafc29c8714481725deec40e37e09ef90b5cbef85157e848",
        "title": "2023年普通高等学校招生全国统一考试（新课标Ⅰ卷）数学",
        "paper_type": "新高考Ⅰ卷",
        "source_type": "local-upload",
        "license_status": "unknown",
        "note": (
            "内容复核：视觉比对确认集合、复数、向量等首页题目，噪声声压表、四棱柱图以及末页第 20 至 22 题数列、投篮、轨迹题与旧版一致。"
            "候选保留“绝密★启用前”、正式卷首及全部 22 题；卷首标注原卷共 4 页，当前重排 PDF 正文为 5 页并有第 6 页空白尾页，试题内容完整。"
            "候选位于河北省份目录，但卷首明确为新课标Ⅰ卷，仍按全国唯一身份归档。替换文件来自用户 temp 目录，来源与授权状态相应更新为本地上传/未知。"
        ),
    },
    "deekur-2023-42-math": {
        "source": "temp/版本2：数学（按省份分类）2008-2024/2008-2024·（辽宁）数学高考真题/2023年高考数学试卷（新课标Ⅱ卷）（空白卷）.pdf",
        "old_sha256": "4201e868c8b8479ac4dad15750e4921cdbb5573e3f486bb71e5504b4118e936f",
        "new_sha256": "c0aae60f80c32b7f68f49f0b7fc88430e4bed24690b91d060d7c910c8e37d8ba",
        "title": "2023年普通高等学校招生全国统一考试（新课标Ⅱ卷）数学",
        "paper_type": "新高考Ⅱ卷",
        "source_type": "local-upload",
        "license_status": "unknown",
        "note": (
            "内容复核：视觉比对确认复数、分层抽样等首页题目，传输概率题、频率分布直方图以及末页第 20 至 22 题三棱锥、双曲线、函数题与旧版一致。"
            "候选全部 22 题完整；当前重排 PDF 正文为 5 页并有第 6 页空白尾页。"
            "候选位于辽宁省份目录，但卷首明确为新课标Ⅱ卷，仍按全国唯一身份归档。替换文件来自用户 temp 目录，来源与授权状态相应更新为本地上传/未知。"
        ),
    },
    "deekur-2023-37-math": {
        "source": "temp/版本2：数学（按省份分类）2008-2024/2008-2024·（广西）数学高考真题/2023年高考数学试卷（文）（全国甲卷）（空白卷）.pdf",
        "old_sha256": "b0065b291618e623fceed198ebd2bd5560060136133b1154c6c4a710096d19a0",
        "new_sha256": "561faf9f3aa8ac7d4de63cf58fb9ba41550a62ef2a490dd45a9c74efc1347aa0",
        "title": "2023年普通高等学校招生全国统一考试（全国甲卷）文科数学",
        "paper_type": "全国甲卷（文科数学）",
        "source_type": "local-upload",
        "license_status": "unknown",
        "note": (
            "内容复核：视觉比对确认集合、复数、向量等首页题目，流程图、小白鼠体重数据以及末页第 20 至 23 题函数、抛物线、选考题与旧版一致。"
            "候选全部题目完整，当前重排 PDF 正文为 5 页并有第 6 页空白尾页。"
            "候选位于广西省份目录，但卷首明确为全国甲卷文科数学，仍按全国唯一身份归档。替换文件来自用户 temp 目录，来源与授权状态相应更新为本地上传/未知。"
        ),
    },
    "deekur-2023-38-math": {
        "source": "temp/版本2：数学（按省份分类）2008-2024/2008-2024·（广西）数学高考真题/2023年高考数学试卷（理）（全国甲卷）（空白卷）.pdf",
        "old_sha256": "47755f41bac1bf10552f5e22eb21720a6ffbc2414ab3b52b981c757c5cb9a756",
        "new_sha256": "71e449a3d4883373a5ac70d99304089d2f06f65ced5c631c2b133cc3655eb3ea",
        "title": "2023年普通高等学校招生全国统一考试（全国甲卷）理科数学",
        "paper_type": "全国甲卷（理科数学）",
        "source_type": "local-upload",
        "license_status": "unknown",
        "note": (
            "内容复核：视觉比对确认集合、程序框图、向量等首页题目，药物小鼠列联表、抛物线以及末页第 20 至 23 题函数、选考题与旧版一致。"
            "候选全部题目完整，当前重排 PDF 正文为 4 页并有第 5 页空白尾页。"
            "候选位于广西省份目录，但卷首明确为全国甲卷理科数学，仍按全国唯一身份归档。替换文件来自用户 temp 目录，来源与授权状态相应更新为本地上传/未知。"
        ),
    },
    "deekur-2023-35-math": {
        "source": "temp/版本2：数学（按省份分类）2008-2024/2008-2024·（河南）数学高考真题/2023年高考数学试卷（文）（全国乙卷）（空白卷）.pdf",
        "old_sha256": "6525ebd5c3be25a2cccff54034938963a28542bd2d682a2c352d61d691b2653e",
        "new_sha256": "5368b3d6e24beec5e94e3578576d470510c6d0d9b9604e72544c6b8242ce0e28",
        "title": "2023年普通高等学校招生全国统一考试（全国乙卷）文科数学",
        "paper_type": "全国乙卷（文科数学）",
        "source_type": "local-upload",
        "license_status": "unknown",
        "note": (
            "内容复核：视觉比对确认复数、集合、三视图等首页题目，橡胶伸缩率数据、椭圆以及末页第 20 至 23 题函数、选考题与旧版一致。"
            "候选全部题目完整，当前重排 PDF 正文为 4 页并有第 5 页空白尾页。"
            "候选位于河南省份目录，但卷首明确为全国乙卷文科数学，仍按全国唯一身份归档。替换文件来自用户 temp 目录，来源与授权状态相应更新为本地上传/未知。"
        ),
    },
    "deekur-2023-36-math": {
        "source": "temp/版本2：数学（按省份分类）2008-2024/2008-2024·（河南）数学高考真题/2023年高考数学试卷（理）（全国乙卷）（空白卷）.pdf",
        "old_sha256": "04a0fd87993b56dde6189990ec44572ea9da95e93d50b74358e42c86ab9be572",
        "new_sha256": "067a280c8982d15dd5bccc565d852d5f17cf6c15a66496dba5844bd44abaaf9d",
        "title": "2023年普通高等学校招生全国统一考试（全国乙卷）理科数学",
        "paper_type": "全国乙卷（理科数学）",
        "source_type": "local-upload",
        "license_status": "unknown",
        "note": (
            "内容复核：视觉比对确认复数、集合、三视图等首页题目，橡胶工艺数据、椭圆以及末页第 20 至 23 题函数、选考题与旧版一致。"
            "候选全部题目完整，当前重排 PDF 正文为 4 页并有第 5 页空白尾页。"
            "候选位于河南省份目录，文件名明确为全国乙卷理科数学，仍按全国唯一身份归档。替换文件来自用户 temp 目录，来源与授权状态相应更新为本地上传/未知。"
        ),
    },
}
...
ADDITIONS = {
    ...
    "temp-v2-2022-英语-670f3084c81b": {
        ...
        "paper_type": "北京卷（笔试）",
        "subject": "英语",
        "title": "2022年普通高等学校招生全国统一考试（北京卷）英语（笔试）",
        "local_path": "papers/2022/BJ/英语/北京英语-试题-p.pdf",
        "note": (
            "用户 temp 目录导入；原始相对路径：版本2：英语（按省份分类）2008-2024/2008-2024·（北京）英语高考真题/2022年高考英语试卷（北京）（机考 无听力）（空白卷）.pdf；格式：pdf；"
            "内容复核：视觉检查确认卷首完形填空、系统思维与营养阅读材料，"
            "以及第 9 页第 41 至 43 题 Fun Bottle 阅读任务和第 44 题英语写作交流邮件完整。"
            "候选将题面标注的 11 页笔试内容重排为 10 页，正文至第 9 页完整结束，第 10 页为空白尾页。"
            "候选文件名明确标注‘机考 无听力’，故本记录仅覆盖英语笔试，不声称包含独立机考听力内容。"
        ),
    },
    ...
    "temp-v2-2023-英语-4d30bc52c504": {
        ...
        "paper_type": "北京卷（笔试）",
        "subject": "英语",
        "title": "2023年普通高等学校招生全国统一考试（北京卷）英语（笔试）",
        "local_path": "papers/2023/BJ/英语/北京英语-试题-p.pdf",
        "note": (
            "用户 temp 目录导入；原始相对路径：版本2：英语（按省份分类）2008-2024/2008-2024·（北京）英语高考真题/2023年高考英语试卷（北京）（机考 无听力）（空白卷）.pdf；格式：pdf；"
            "内容复核：视觉检查确认卷首知识运用完形填空、阅读理解与第 5 页气候变化阅读材料，"
            "以及第 9 页第 43 题书面表达和第 44 题‘绿色北京’建议信完整。"
            "PDF 页码共 10 页，笔试正文至第 9 页完整结束，第 10 页为空白尾页。"
            "候选文件名明确标注‘机考 无听力’，故本记录仅覆盖英语笔试，不声称包含独立机考听力内容。"
        ),
    },
